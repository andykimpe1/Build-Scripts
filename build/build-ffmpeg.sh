...
if ! ${INSTX_TOPDIR}/build/build-x264.sh
then
...
if ! ${INSTX_TOPDIR}/build/build-x265.sh
then
...
if [[ -e ${INSTX_TOPDIR}/patch/ffmpeg.patch ]]; then
    echo ""
    echo "**********************"
    echo "Patching package"
    echo "**********************"

    patch -u -p0 < ${INSTX_TOPDIR}/patch/ffmpeg.patch
fi
