...
if ! ${INSTX_TOPDI${INSTX_TOPDIR}/build/build-mpfr.sh
then
...
if [[ -e ${INSTX_TOPDIR}/build/build/gawk.patch ]]; then
    echo ""
    echo "***************************"
    echo "Patching package"
    echo "***************************"

    patch -u -p0 < ${INSTX_TOPDIR}/build/build/gawk.patch
fi
