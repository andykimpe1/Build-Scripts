...
if ! ${INSTX_TOPDI${INSTX_TOPDIR}/build/build-gnutls.sh
then
...
if [[ -e ${INSTX_TOPDIR}/build/build/microhttpd.patch ]]; then
    echo ""
    echo "**********************"
    echo "Patching package"
    echo "**********************"

    patch -u -p0 < ${INSTX_TOPDIR}/build/build/microhttpd.patch
fi
