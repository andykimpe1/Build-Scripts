...
if ! ${INSTX_TOPDIR}/build/build-libbsd.sh
then
...
if [[ -e ${INSTX_TOPDIR}/patch/mg.patch ]]; then
    echo ""
    echo "**********************"
    echo "Patching package"
    echo "**********************"

    patch -u -p0 < ${INSTX_TOPDIR}/patch/mg.patch
fi
...
if false; then
    ...
    # ${INSTX_TOPDIR}/build/build-mg.sh 2>&1 | tee build-mg.log
