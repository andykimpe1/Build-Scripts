...
if ! ${INSTX_TOPDI${INSTX_TOPDIR}/build/build-libosip2.sh
then
...
if [[ -e ${INSTX_TOPDIR}/build/build/libexosip2.patch ]]; then
    patch -u -p0 < ${INSTX_TOPDIR}/build/build/libexosip2.patch
    echo ""
fi
