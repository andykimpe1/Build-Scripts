...
if [[ -e ${INSTX_TOPDIR}/build/build/nettle.patch ]]; then
    echo ""
    echo "***************************"
    echo "Patching package"
    echo "***************************"

    patch -u -p0 < ${INSTX_TOPDIR}/build/build/nettle.patch
fi

if [[ -e ${INSTX_TOPDIR}/build/build/nettle-darwin.patch ]]; then
    echo ""
    echo "***************************"
    echo "Patching package (Darwin)"
    echo "***************************"

    patch -u -p0 < ${INSTX_TOPDIR}/build/build/nettle-darwin.patch
fi
