...
if [[ -e ${INSTX_TOPDIR}/patch/nettle.patch ]]; then
    echo ""
    echo "***************************"
    echo "Patching package"
    echo "***************************"

    patch -u -p0 < ${INSTX_TOPDIR}/patch/nettle.patch
fi

if [[ -e ${INSTX_TOPDIR}/patch/nettle-darwin.patch ]]; then
    echo ""
    echo "***************************"
    echo "Patching package (Darwin)"
    echo "***************************"

    patch -u -p0 < ${INSTX_TOPDIR}/patch/nettle-darwin.patch
fi
