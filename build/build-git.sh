...
if ! ${INSTX_TOPDI${INSTX_TOPDIR}/build/build-curl.sh
then
...
if ! ${INSTX_TOPDI${INSTX_TOPDIR}/build/build-less.sh
then
...
if [[ -e ${INSTX_TOPDIR}/build/build/git.patch ]]; then
    echo ""
    echo "***********************"
    echo "Patching package"
    echo "***********************"

    patch -u -p0 < ${INSTX_TOPDIR}/build/build/git.patch
fi
