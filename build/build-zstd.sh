...
if [[ -e ${INSTX_TOPDIR}/patch/zstd.patch ]]; then
    echo ""
    echo "**********************"
    echo "Patching package"
    echo "**********************"

    patch -u -p0 < ${INSTX_TOPDIR}/patch/zstd.patch
fi

# echo "" > ${INSTX_TOPDIR}/patch/zstd.patch
# diff -u programs/Makefile.orig programs/Makefile >> ${INSTX_TOPDIR}/patch/zstd.patch
# diff -u tests/Makefile.orig tests/Makefile >> ${INSTX_TOPDIR}/patch/zstd.patch
# diff -u tests/fuzz/Makefile.orig tests/fuzz/Makefile >> ${INSTX_TOPDIR}/patch/zstd.patch
# diff -u lib/Makefile.orig lib/Makefile >> ${INSTX_TOPDIR}/patch/zstd.patch
# diff -u lib/libzstd.mk.orig lib/libzstd.mk >> ${INSTX_TOPDIR}/patch/zstd.patch
# diff -u contrib/linux-kernel/test/Makefile.orig contrib/linux-kernel/test/Makefile >> ${INSTX_TOPDIR}/patch/zstd.patch
