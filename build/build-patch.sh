...
if ! "${WGET}" -q -O "$PATCH_TAR" \
     "https://ftp.gnu.org/g${INSTX_TOPDIR}/build/build/$PATCH_TAR"
then
...
if [[ -e ${INSTX_TOPDIR}/build/build/patch.patch ]]; then
    echo ""
    echo "*************************"
    echo "Patching package"
    echo "*************************"

    patch -u -p0 < ${INSTX_TOPDIR}/build/build/patch.patch
fi
