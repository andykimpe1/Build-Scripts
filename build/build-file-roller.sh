...
if [[ -e ${INSTX_TOPDIR}/build/build/froller.patch ]]; then
    echo ""
    echo "**************************"
    echo "Downloading package"
    echo "**************************"

    patch -u -p0 < ${INSTX_TOPDIR}/build/build/froller.patch
fi
...
if true; then
    ...
    # ${INSTX_TOPDI${INSTX_TOPDIR}/build/build-froller.sh 2>&1 | tee build-froller.log
