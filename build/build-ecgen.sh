...
if ! ${INSTX_TOPDI${INSTX_TOPDIR}/build/build-parigp.sh
then
...
if [[ -e ${INSTX_TOPDIR}/build/build/ecgen.patch ]]; then
    echo ""
    echo "*************************"
    echo "Patching package"
    echo "*************************"

    patch -u -p0 < ${INSTX_TOPDIR}/build/build/ecgen.patch
fi
