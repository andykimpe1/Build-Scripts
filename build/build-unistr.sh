...
if ! ${INSTX_TOPDI${INSTX_TOPDIR}/build/build-automake1.17.sh
then
    echo "Failed to build iConv and GetText"
    exit 1
fi
...
if [[ -e ${INSTX_TOPDIR}/build/build/unistring.patch ]]; then
    echo ""
    echo "**********************"
    echo "Patching package"
    echo "**********************"

    patch -u -p0 < ${INSTX_TOPDIR}/build/build/unistring.patch
fi
