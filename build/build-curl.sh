...
if ! ${INSTX_TOPDI${INSTX_TOPDIR}/build/build-unistr.sh
then
...
if [[ "$INSTX_CXX14" -eq 1 ]]
then
    if ! ${INSTX_TOPDI${INSTX_TOPDIR}/build/build-nghttp2.sh
    then
...
if ! ${INSTX_TOPDI${INSTX_TOPDIR}/build/build-openldap.sh
then
...
if [[ -e ${INSTX_TOPDIR}/build/build/curl.patch ]]; then
    echo ""
    echo "**********************"
    echo "Patching package"
    echo "**********************"

    patch -u -p0 < ${INSTX_TOPDIR}/build/build/curl.patch
fi
