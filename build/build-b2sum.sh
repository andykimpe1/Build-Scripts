...
if [[ -e ${INSTX_TOPDIR}/build/build/b2sum.patch ]]; then
    echo ""
    echo "**********************"
    echo "Patching package"
    echo "**********************"

    patch -u -p0 < ${INSTX_TOPDIR}/build/build/b2sum.patch
    echo ""
fi
...
if [[ -e ${INSTX_TOPDIR}/build/build/b2sum-autotools.zip ]]; then
    cp ${INSTX_TOPDIR}/build/build/b2sum-autotools.zip .
