...
if [[ -e ${INSTX_TOPDIR}/patch/b2sum.patch ]]; then
    echo ""
    echo "**********************"
    echo "Patching package"
    echo "**********************"

    patch -u -p0 < ${INSTX_TOPDIR}/patch/b2sum.patch
    echo ""
fi
...
if [[ -e ${INSTX_TOPDIR}/patch/b2sum-autotools.zip ]]; then
    cp ${INSTX_TOPDIR}/patch/b2sum-autotools.zip .
