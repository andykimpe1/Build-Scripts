...
if ! ${INSTX_TOPDI${INSTX_TOPDIR}/build/build-m4.sh
then
...
if ! ${INSTX_TOPDI${INSTX_TOPDIR}/build/build-autoconf.sh
then
...
if ! ${INSTX_TOPDI${INSTX_TOPDIR}/build/build-automake.sh
then
...
if ! ${INSTX_TOPDI${INSTX_TOPDIR}/build/build-libtool.sh
then
