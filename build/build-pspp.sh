...
if ! ${INSTX_TOPDI${INSTX_TOPDIR}/build/build-libgsl.sh
then
...
if [[ -e ${INSTX_TOPDIR}/build/build/pspp.patch ]]; then
    patch -u -p0 < ${INSTX_TOPDIR}/build/build/pspp.patch
    echo ""
fi
