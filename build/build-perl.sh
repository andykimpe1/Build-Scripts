...
if ! ${INSTX_TOPDI${INSTX_TOPDIR}/build/build-cacert.sh
then
...
if ! ${INSTX_TOPDI${INSTX_TOPDIR}/build/build-zlib.sh
then
...
if ! ${INSTX_TOPDI${INSTX_TOPDIR}/build/build-bzip.sh
then
...
if ! ${INSTX_TOPDI${INSTX_TOPDIR}/build/build-base.sh
then
...
if ! ${INSTX_TOPDI${INSTX_TOPDIR}/build/build-gdbm.sh
then
...
if ! ${INSTX_TOPDI${INSTX_TOPDIR}/build/build-bdb.sh
then
...
if [[ ! -f "$INSTX_PREFIX/bin/sed" ]]; then
    if ! ${INSTX_TOPDI${INSTX_TOPDIR}/build/build-sed.sh
    then
...
if [[ -e ${INSTX_TOPDIR}/build/build/perl.patch ]]; then
    ...
    echo ""
    patch -u -p0 < ${INSTX_TOPDIR}/build/build/perl.patch
...
#diff -u op.c.orig op.c > ${INSTX_TOPDIR}/build/build/perl.patch
#diff -u pp.c.orig pp.c >> ${INSTX_TOPDIR}/build/build/perl.patch
#diff -u sv.c.orig sv.c >> ${INSTX_TOPDIR}/build/build/perl.patch
#diff -u numeric.c.orig numeric.c >> ${INSTX_TOPDIR}/build/build/perl.patch
#diff -u regcomp.c.orig regcomp.c >> ${INSTX_TOPDIR}/build/build/perl.patch
#diff -u vms/vms.c.orig vms/vms.c >> ${INSTX_TOPDIR}/build/build/perl.patch
#diff -u ext/POSIX/POSIX.xs.orig ext/POSIX/POSIX.xs >> ${INSTX_TOPDIR}/build/build/perl.patch
#diff -u cpan/Compress-Raw-Zlib/zlib-src/zutil.c.orig cpan/Compress-Raw-Zlib/zlib-src/zutil.c >> ${INSTX_TOPDIR}/build/build/perl.patch
