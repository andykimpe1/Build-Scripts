...
if ! ${INSTX_TOPDIR}/build/build-hiredis.sh
then
...
if ! ${INSTX_TOPDIR}/build/build-rootkey.sh
then
...
if [[ -e ${INSTX_TOPDIR}/patch/unbound.patch ]]; then
    patch -u -p0 < ${INSTX_TOPDIR}/patch/unbound.patch
    echo ""
fi
