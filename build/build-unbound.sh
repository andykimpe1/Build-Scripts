...
if ! ${INSTX_TOPDI${INSTX_TOPDIR}/build/build-hiredis.sh
then
...
if ! ${INSTX_TOPDI${INSTX_TOPDIR}/build/build-rootkey.sh
then
...
if [[ -e ${INSTX_TOPDIR}/build/build/unbound.patch ]]; then
    patch -u -p0 < ${INSTX_TOPDIR}/build/build/unbound.patch
    echo ""
fi
