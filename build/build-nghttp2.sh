...
if ! ${INSTX_TOPDI${INSTX_TOPDIR}/build/build-jansson.sh
then
...
if [[ -e ${INSTX_TOPDIR}/build/build/nghttp2.patch ]]; then
    echo ""
    echo "**********************"
    echo "Patching package"
    echo "**********************"

    patch -u -p0 < ${INSTX_TOPDIR}/build/build/nghttp2.patch
fi
