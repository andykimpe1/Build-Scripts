...
if ! ${INSTX_TOPDI${INSTX_TOPDIR}/build/build-unzip.sh
then
...
#if [[ -e ${INSTX_TOPDIR}/build/build/bzip-makefiles.zip ]]; then
#    echo ""
#    echo "****************************"
#    echo "Updating makefiles"
#    echo "****************************"
#
#    cp ${INSTX_TOPDIR}/build/build/bzip-makefiles.zip .
#    unzip -oq bzip-makefiles.zip
#fi

# Now, patch them for this script.
if [[ -e ${INSTX_TOPDIR}/build/build/bzip.patch ]]; then
    echo ""
    echo "****************************"
    echo "Patching package"
    echo "****************************"

    patch -u -p0 < ${INSTX_TOPDIR}/build/build/bzip.patch
fi
