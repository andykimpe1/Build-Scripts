...
if ! ${INSTX_TOPDI${INSTX_TOPDIR}/build/build-xproto.sh
then
...
if [[ -e ${INSTX_TOPDIR}/build/build/makedepend.patch ]]; then
    echo ""
    echo "******************************"
    echo "Patching package"
    echo "******************************"

    patch -u -p0 < ${INSTX_TOPDIR}/build/build/makedepend.patch
fi
