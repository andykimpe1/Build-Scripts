...
if ! ${INSTX_TOPDI${INSTX_TOPDIR}/build/build-ucommon.sh
then
...
if ! ${INSTX_TOPDI${INSTX_TOPDIR}/build/build-libosip2-rc.sh
then
...
if [[ -e ${INSTX_TOPDIR}/build/build/libexosip2-rc.patch ]]; then
    patch -u -p0 < ${INSTX_TOPDIR}/build/build/libexosip2-rc.patch
    echo ""
fi
