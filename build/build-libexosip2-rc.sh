...
if ! ${INSTX_TOPDIR}/build/build-ucommon.sh
then
...
if ! ${INSTX_TOPDIR}/build/build-libosip2-rc.sh
then
...
if [[ -e ${INSTX_TOPDIR}/patch/libexosip2-rc.patch ]]; then
    patch -u -p0 < ${INSTX_TOPDIR}/patch/libexosip2-rc.patch
    echo ""
fi
