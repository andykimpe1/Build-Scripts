...
if ! ${INSTX_TOPDIR}/build/build-gzip.sh
then
...
if ! ${INSTX_TOPDIR}/build/build-parigp-data.sh
then
...
if [[ -e ${INSTX_TOPDIR}/patch/parigp.patch ]]; then
     echo ""
     echo "***************************"
     echo "Patching package"
     echo "***************************"

    patch -u -p0 < ${INSTX_TOPDIR}/patch/parigp.patch
fi
