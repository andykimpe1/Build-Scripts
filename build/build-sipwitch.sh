...
if ! ${INSTX_TOPDI${INSTX_TOPDIR}/build/build-libexosip2-rc.sh
then
...
if [[ -e ${INSTX_TOPDIR}/build/build/sipwitch-rc.patch ]]; then
    patch -u -p0 < ${INSTX_TOPDIR}/build/build/sipwitch-rc.patch
    echo ""
fi
