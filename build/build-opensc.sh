...
if ! ${INSTX_TOPDI${INSTX_TOPDIR}/build/build-pcsclite.sh
then
...
if [[ -e ${INSTX_TOPDIR}/build/build/opensc.patch ]]; then
    patch -u -p0 < ${INSTX_TOPDIR}/build/build/opensc.patch
    echo ""
fi
