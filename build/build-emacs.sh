...
if ! ${INSTX_TOPDI${INSTX_TOPDIR}/build/build-libxml2.sh
then
...
if ! ${INSTX_TOPDI${INSTX_TOPDIR}/build/build-gmp.sh
then
...
if [[ -e ${INSTX_TOPDIR}/build/build/emacs.patch ]]; then
    echo ""
    echo "**********************"
    echo "Patching package"
    echo "**********************"

    patch -u -p0 < ${INSTX_TOPDIR}/build/build/emacs.patch
fi
