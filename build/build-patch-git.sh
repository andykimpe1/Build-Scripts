...
if ! git clone https://git.savannah.gnu.org/g${INSTX_TOPDIR}/patch.git "${PATCH_DIR}"
then
...
if [[ -e ${INSTX_TOPDIR}/patch/patch-master.patch ]]; then
    patch -u -p0 < ${INSTX_TOPDIR}/patch/patch-master.patch
    echo ""
fi
