...
if ! ${INSTX_TOPDI${INSTX_TOPDIR}/build/build-makedepend.sh
then
...
if [[ -e ${INSTX_TOPDIR}/build/build/openssl-1.0.2.patch ]]; then
    echo ""
    echo "***************************"
    echo "Patching package"
    echo "***************************"

    patch -u -p0 < ${INSTX_TOPDIR}/build/build/openssl-1.0.2.patch
fi
